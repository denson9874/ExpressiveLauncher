...
`/Users/daryldenson/Library/Application Support/Expressive CI/releases/qa-1.0.8-9-build-1/`.
The release receipt is retained at:
`/Users/daryldenson/Library/Application Support/Expressive CI/agent/workspace/expressive-qa-publish/publication-1.json`.
