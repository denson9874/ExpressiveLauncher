...
`/Users/daryldenson/Library/Application Support/Expressive CI/releases/qa-1.0.9-10-build-2/`.

The publication receipt is:
`/Users/daryldenson/Library/Application Support/Expressive CI/agent/workspace/expressive-qa-publish/publication-2.json`.
...
`/Users/daryldenson/Library/Application Support/Expressive CI/delivery/qa-1.0.9-10-build-2/`.
