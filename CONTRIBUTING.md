...
The active GitHub attribution workflow checks notices and selected headers only.
Application build, signing, device validation, and publication remain in Jenkins.
