...
/** Branding retained exclusively for the non-Expressive Lawnchair build flavors. */
internal val lawnchairTeam = listOf(
    TeamMember(
        name = "Amogh Lele",
...
internal val lawnchairSupportAndPr = listOf(
    TeamMember(
        name = "Daniel Souza",
        role = Role.Support,
...
internal val lawnchairTopLinks = listOf(
    Link(
...
internal val lawnchairBottomLinks = listOf(
    Link(
